...
public class CourseType implements Serializable {
	...
	public CourseType(Integer id, String typeName, Integer parentId, CourseType parent, Integer status) {
		this.id = id;
	...
	public String toString() {
		return "CourseType [id=" + id + ", typeName=" + typeName + ", parentId=" + parentId + ", parent=" + parent
